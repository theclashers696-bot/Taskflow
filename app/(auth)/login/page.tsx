    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 p-4">
      <Card className="w-full max-w-md border-white/10 bg-white/5 backdrop-blur-sm text-white">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-slate-400">Sign in to your TaskFlow account</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-slate-500"><span className="bg-transparent px-2">or continue with email</span></div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input {...register("password")} type="password" placeholder="••••••••" className="bg-white/10 border-white/20 text-white placeholder:text-slate-500 focus:border-blue-400" />
        ...
        <CardFooter className="justify-center">
          <p className="text-sm text-slate-400">
            ...
            <Link href="/sign-up" className="text-blue-400 hover:text-blue-300 font-medium">Sign up free</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
